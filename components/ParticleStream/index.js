...
export const ParticleStream = () => {
    ...
    async function initControls() {
        ...
        mControls.autoRotateSpeed = 0.5;
    }

    function initParticleSystem() {
        var prefabGeometry = new THREE.PlaneGeometry(4, 4);
        var bufferGeometry = new BAS.PrefabBufferGeometry(prefabGeometry, mParticleCount);
        ...
        for (i = 0, offset = 0; i < mParticleCount; i++) {
            // TODO modify color to accept a set range
            h = i / mParticleCount;
    ...
    function update() {
        mControls.update();
        // console.log('Azimuth: ', mControls.getAzimuthalAngle());
        // console.log('Polar: ', mControls.getPolarAngle());
 ...
 */
    ...
    BAS.PrefabBufferGeometry.prototype.createAttribute = function (name, itemSize) {
